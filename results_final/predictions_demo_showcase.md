...
8 hand-picked tablet(s) (`--tablet_ids`). Both models see the exact same masked positions per example (bold **?** shown at every chosen position, 15% of eligible tokens) -- differences in restoration come only from the two models' separately trained weights, not from the image itself (the image only reaches `provenience_head`, see module docstring). The metadata table's `provenience` row is where the image can actually change an answer.
...
> **x** **x** pi **...** e taš - hu **x** **...** im - mar **x** **...** ib - bu - u **x** **...** ib - ši šu **...** i - nak - kir **x** **...**
...
> **x** **x** **?** **...** e ta **?** - hu **x** **...** im - mar **x** **...** ib - bu - u **x** **...** ib - ši šu **...** i - **?** - ki **?** **x** **...**
...
**Original text (transliteration):**
> **x** **x** **x** **x** lu - u **x** **x** **x** **x** **x** **x** **x** **x** **x** **x** **x** ki - ma kip - pa - ti₃ **x** **x** **x** **x** **x** ku - up - ru lu da - an e - liš u šap - liš **x** **x** **x** - e pe - hi MA₂ u₂ - ṣur a - dan - na ša₂ a - šap - pa - rak - ka MA₂ e - ru - um - ma KA₂ MA₂ tir - ra zi - ib - la ina lib₃ - bi - ša₂ ŠE. BAR - ka NIG₂. ŠU - ka u NIG₂. GA - ka aš₂ - šat - ka ki - mat - ka sa - lat - ka u DUMU - MEŠ um - ma - ni bu - ul EDIN u₂ - ma - am EDIN ma - la U₂. ŠIM me - er - ʾi - sun a - šap - pa - rak - kum₂ - ma i - na - aṣ - ṣa - ru KA₂ - ka at - ra - ha - sis pa - a - šu₂ DU₃ - ma DUG₄. GA i - zak - kar ana e₂ - a be - li₂ - šu₂ ma - ti - ma - a MA₂ ul e - pu - uš **x** **x** ina qaq - qa - ri e - ṣir u₂ - ṣur - tu₂ u₂ - ṣur - tu lu - mur - ma MA₂ lu - pu - uš e₂ - a ina qaq - qa - ri e - ṣir u₂ - ṣur - tu **x** **x** **x** be - li₂ ša₂ taq - ba - a **x** **x** **x** **x** **x** **x**
...
> **x** **x** **x** **x** lu - u **x** **x** **x** **x** **x** **x** **x** **x** **x** **x** **x** **?** - ma kip - pa - ti₃ **x** **x** **x** **x** **x** **?** - **?** **?** ru lu da - an **?** - liš u šap - liš **x** **x** **x** - e pe - hi MA₂ u **?** - ṣur **?** - dan **?** na **?**₂ a **?** šap - pa - rak - ka MA₂ **?** - ru - um - ma KA **?** MA₂ tir - ra zi - **?** - **?** ina lib₃ - bi - ša₂ ŠE. BAR - ka NIG₂. **?** - ka u NIG₂. GA **?** **?** **?**₂ **?** šat - ka **?** - mat - ka sa **?** lat - ka u DUMU - MEŠ um - **?** - ni bu - **?** ED **?** u₂ - ma - am ED **?** ma - la U₂. ŠIM me - er - ʾi - sun a - šap - **?** - **?** - **?**m₂ - ma i - **?** - **?**ṣ - ṣa - ru KA₂ **?** **?** at - ra - ha - sis pa - a - šu₂ DU₃ - ma DUG **?**. **?** i - zak - kar ana e₂ - a be **?** li₂ - šu₂ **?** - ti - ma - a MA₂ ul e - pu - uš **x** **x** ina qaq - qa - ri e **?** ṣir u₂ - ṣur - tu₂ u₂ - ṣur **?** tu lu - mur **?** ma MA **?** lu - pu - **?** e₂ - a ina qaq **?** qa - ri e - **?** **?** u₂ - ṣur **?** **?** **x** **x** **x** be - li₂ ša₂ **?**q - ba - **?** **x** **x** **x** **x** **x** **x**
...
**Original text (transliteration):**
> man - za - zu i - pa - aš₂ - šum - ma is - sah - ra il - lik SIM u₂ - maš - šar : **...** u₂ - še - ṣi - ma a - ri - ba u₂ - maš - šar : **...** ik - kal i - ša₂ - ah - hi i - tar - ri ul is - sah - ra

**Cuneiform (Unicode signs, whole document, not position-aligned to the text above):**
> 𒄿 𒉺 𒀾 š 𒅎 𒄷 𒌑 𒈦 š 𒊑 𒁀 𒌑 𒅈 𒊑 𒌌

**Masked input (11 positions):**
> man - za - zu **?** - pa **?** aš **?** - **?** - ma is - sah - ra il - lik SI **?** u₂ - maš **?** šar : **...** u₂ - **?** - **?** - ma a - ri - ba u₂ - **?** - šar : **...** ik - kal i - **?**₂ - ah - hi i - tar - ri ul is **?** sah - ra
...
**Original text (transliteration):**
> mul - lil AN - e u KI - ti₃ **...** ša₂ a - na du - un - ni **...** a - bit DINGIR - MEŠ ša₂ **...**

**Cuneiform (Unicode signs, whole document, not position-aligned to the text above):**
> 𒀯 𒇸 𒀀 𒈾 𒁺 𒌦 𒂍 𒀭 𒈨𒌍 𒃻

**Masked input (5 positions):**
> mul - lil **?** **?** e u KI - **?**₃ **...** ša₂ a - na du - **?** - ni **...** a - bit **?** - MEŠ ša₂ **...**
...
**Original text (transliteration):**
> **...** **x** TUKUL i - **...** **...** **x** ina GU. ZA **x** **...** **...** + en - lil₂ KA - šu₂ DU₃ - ma **...** **...** zag - ga - **x** **x** **...**

**Cuneiform (Unicode signs, whole document, not position-aligned to the text above):**
> x 𒄑 𒆪 𒄿 x 𒀸 𒄑 x 𒅍 𒅗 𒋙 𒀭 𒍠 𒂵 x

**Masked input (4 positions):**
> **...** **x** TUKUL i - **...** **...** **x** ina GU. **?**A **x** **...** **...** + en - lil₂ KA - šu₂ **?** **?** **?** ma **...** **...** zag - ga - **x** **x** **...**
...
**Original text (transliteration):**
> i - zu - uz - zu **...** **x** mu **...** ṣe - eh - ri - im ša aš - ša - tum la ah - zu e - li - at ši₂ - ti - šu

**Cuneiform (Unicode signs, whole document, not position-aligned to the text above):**
> 𒍪 𒊻 x 𒈬 𒂊 𒄴 š 𒊭 𒌈 𒆷 𒀀 𒇷 𒀜

**Masked input (6 positions):**
> i - zu - **?** - zu **...** **x** mu **...** ṣe **?** eh - ri **?** im ša aš - ša - tum la ah - zu e - **?** - at ši₂ **?** ti **?** šu
...
**Masked input (11 positions):**
> ša ni - iš **?**₂ - **?** - šu IŠKUR i - du - u₂ mu - ne - eh li - **?** **?** bi IŠK **?** qu₂ - ra - **?** **?** im i - na IM mu **?** uš - **?** - ak - ki - in si - ma - tim i - na e₂ - u₄ **?** gal **?** gal
...
> um - ma i - **?** - suen - ma utu marduk u₃ nin - šubur ṣu₂ **?** ba - a - at a - **?** **?** le - e ša - at - tam a - na ša **?** at - tim i - da - am - **?** **?** **?**₂ at - ti ṣu₂ - ba - a **?** **?** tu **?** qa₂ - al **?** la **?** **?** i - na ṣu₂ - ba - ti - ia qu₃ - ul - lu - lim u₃ ku - uz **?** zi ta - **?** - ta - ri - i i - na siki hi - **?** i **?** na bi - ti - **?** **?** **?** ma a - ka - lim in - na - ka - **?** at - ti ṣu₂ - ba - ti **?** - qa₂ - al - li - li dumu iškur **?** i - di₂ - nam ša a - bu **?** šu ṣu₂ - ha - ar a **?** bi **?** ia ši - na **?**u **?** - ba - te - e eš - šu - tim **?** - bi **?** iš at **?** ti a - na ṣu₂ - ba - ti **?** ia iš - te **?** en ta - ta - na - ah - da - ri **?** - ma **?** - ti ia - **?** tu - ul - di - in - ni **?** - a - **?** **?** - ma - šu a - na **?** - qi₂ **?** tim u **?** ki - ma ša - a - **?** **?** - ma - šu i **?** ra - a - mu - šu at - ti ia - a - ti **?**₂ - ul ta - ra **?** **?** - mi - in - **?**
