...
**Original text (transliteration):**
> 01 zirruxSAL. NUNUZ. ZI. AN. ŠEŠ. KI dam nanna e₂ inanna - za - za mu - še₃ be₂ - sa₄

**Cuneiform (Unicode signs, whole document, not position-aligned to the text above):**
> 𒁮 𒌶𒆠 𒈹 𒍝 𒍝 𒈬 𒂠 𒁉

**Masked input (6 positions):**
> 01 <strong>?</strong>rrux <strong>?</strong>L. NUNUZ. ZI <strong>?</strong> <strong>?</strong>. ŠEŠ. KI <strong>?</strong> nanna e₂ inanna - za - za mu - še <strong>?</strong> be₂ - sa₄

### Restoration (masked-token predictions)

| # | true token | text-only top-1 | text-only top-3 | vision top-1 | vision top-3 | text-only correct | vision correct |
|---|---|---|---|---|---|---|---|
| 1 | `zi` | `bu` | `bu`, `še`, `za` | `bu` | `bu`, `še`, `za` | ❌ | ❌ |
| 2 | `##SA` | `##SA` | `##SA`, `SA`, `##HA` | `##SA` | `##SA`, `##HA`, `##KA` | ✅ | ✅ |
| 3 | `.` | `.` | `.`, `##Š`, `##×` | `.` | `.`, `##Š`, `##Z` | ✅ | ✅ |
| 4 | `AN` | `##₂` | `##₂`, `A`, `ŠU` | `##₂` | `##₂`, `A`, `##U` | ❌ | ❌ |
| 5 | `dam` | `##N` | `##N`, `##D`, `##Š` | `##N` | `##N`, `##D`, `##Š` | ❌ | ❌ |
| 6 | `##₃` | `##₃` | `##₃`, `-`, `##š` | `-` | `-`, `##₃`, `##š` | ✅ | ❌ |

Top-1 accuracy on this example: text-only 3/6 (50%), vision 2/6 (33%)

### Metadata predictions

| head | ground truth | text-only prediction | vision prediction |
|---|---|---|---|
| period | Third Millennium | Ur III (0.38) | Third Millennium (0.53) **<- differs** |
| genre | Royal Inscriptions | Administrative (0.97) | Administrative (0.96) |
| language | (no label) | Sumerian (0.81) | Sumerian (0.62) |
| provenience | Ur | Ur (0.88) | Šuruppak (0.23) **<- differs** |
...
> i₃ - <strong>?</strong> an ṣi <strong>?</strong> ru - um lugal a - nun - <strong>?</strong> - ki be - el ša - me <strong>?</strong> e <strong>?</strong>₃ er <strong>?</strong> <strong>?</strong>e - <strong>?</strong> ša <strong>?</strong> i <strong>?</strong> im ši - ma - at kalam <strong>?</strong> <strong>?</strong> <strong>?</strong> <strong>?</strong>duk dumu re - <strong>?</strong> - ti - im ša en - ki en - li <strong>?</strong>₂ - ut <strong>?</strong> ni - ši₃ i - ši - mu - šum in i - gi₄ - gi₄ u₂ <strong>?</strong> šar - bi <strong>?</strong> <strong>?</strong> u₃ - šu šum - šu ṣi - <strong>?</strong> - am <strong>?</strong>b - bi - <strong>?</strong>₃ in ki <strong>?</strong> ib <strong>?</strong> ra - <strong>?</strong> u₂ - ša - ṭe₄ - ru - šu i - <strong>?</strong> li - ib - bi - šu šar - ru - tam da - ri₂ - tam ša ki - ma ša - me <strong>?</strong> e iš - <strong>?</strong> - ša šu - ur₂ - <strong>?</strong> - da u₂ - ki - in - nu - šum ha - am - mu - ra - pi₂ na - <strong>?</strong> ' <strong>?</strong> dam <strong>?</strong> - li - ih i <strong>?</strong> - li₂ <strong>?</strong> - ti mi - ša <strong>?</strong> ra - <strong>?</strong> i - na ma - tim <strong>?</strong> - na <strong>?</strong> - pi <strong>?</strong> - i - im ra <strong>?</strong> ga - am u₃ ṣe - nam a - na hu - <strong>?</strong> - lu - qi₂ - im dan - <strong>?</strong> - <strong>?</strong> en - ša - <strong>?</strong> a - na la ha - ba - li - <strong>?</strong> ki - <strong>?</strong> utu a - na <strong>?</strong> - ge₆ wa - ṣe - e - em - ma nu - wu - ri - im <strong>?</strong> - na ši - ir ni <strong>?</strong> ši ṭ <strong>?</strong> <strong>?</strong> - u <strong>?</strong> - bi - im <strong>?</strong> - <strong>?</strong> ib - bu - u₂ re - iu - um ni - bi - it <strong>?</strong> - lil₂ a - na <strong>?</strong> ku <strong>?</strong> <strong>?</strong> kam - me - er nu - uh₂ - <strong>?</strong> - im u₃ ṭu₂ - uh₂ - di - im <strong>?</strong> - ša - ak - li - <strong>?</strong> mi - im <strong>?</strong> ma šum - šu a - na nibru dur - an - ki <strong>?</strong> - ni - nu - um na - a <strong>?</strong> - <strong>?</strong> <strong>?</strong> <strong>?</strong> ša e₂ - <strong>?</strong> lugal le - <strong>?</strong> - um mu - te - er eridu mu - <strong>?</strong>b - bi - ib šu - <strong>?</strong>h <strong>?</strong>₂ - ab <strong>?</strong> ti - i - ib ki - ib - ra - at er - be <strong>?</strong> - ti
...
| 6 | `-` | `-` | `-`, `##₂`, `##₃` | `-` | `-`, `##₂`, `##₃` | ✅ | ✅ |
| 7 | `ṣ` | `be` | `be`, `ṣ`, `ṭ` | `be` | `be`, `ṣ`, `ṭ` | ❌ | ❌ |
| 8 | `tim` | `ti` | `ti`, `tim`, `a` | `ti` | `ti`, `tim`, `te` | ❌ | ❌ |
| 9 | `-` | `-` | `-`, `iri`, `ki` | `-` | `-`, `iri`, `ša` | ✅ | ✅ |
| 10 | `-` | `-` | `-`, `##₃`, `/` | `-` | `-`, `##₃`, `##₂` | ✅ | ✅ |
| 11 | `a` | `-` | `-`, `ki`, `i` | `-` | `-`, `D`, `ki` | ❌ | ❌ |
| 12 | `-` | `ma` | `ma`, `-`, `me` | `ma` | `ma`, `-`, `ut` | ❌ | ❌ |
| 13 | `na` | `-` | `-`, `##₂`, `##₃` | `-` | `-`, `##₂`, `##u` | ❌ | ❌ |
| 14 | `mar` | `mar` | `mar`, `Mar`, `eri` | `mar` | `mar`, `Mar`, `eri` | ✅ | ✅ |
| 15 | `eš` | `e` | `e`, `eš`, `me` | `e` | `e`, `eš`, `me` | ❌ | ❌ |
| 16 | `##l` | `##l` | `##l`, `##la`, `##m` | `##l` | `##l`, `##m`, `##la` | ✅ | ✅ |
| 17 | `kiš` | `##u` | `##u`, `-`, `##tu` | `##u` | `##u`, `-`, `##um` | ❌ | ❌ |
| 18 | `-` | `-` | `-`, `.`, `:` | `-` | `-`, `.`, `##₂` | ✅ | ✅ |
| 19 | `##₂` | `-` | `-`, `##₂`, `##₄` | `-` | `-`, `##₂`, `##₄` | ❌ | ❌ |
| 20 | `-` | `im` | `im`, `it`, `ir` | `im` | `im`, `šu`, `it` | ❌ | ❌ |
| 21 | `ra` | `ru` | `ru`, `ra`, `ri` | `ru` | `ru`, `ra`, `ri` | ❌ | ❌ |
| 22 | `i` | `i` | `i`, `u`, `di` | `i` | `i`, `di`, `u` | ✅ | ✅ |
| 23 | `u` | `še` | `še`, `ka`, `am` | `še` | `še`, `ka`, `sa` | ❌ | ❌ |
| 24 | `-` | `-` | `-`, `##₂`, `:` | `-` | `-`, `##₂`, `:` | ✅ | ✅ |
| 25 | `-` | `-` | `-`, `.`, `:` | `-` | `-`, `.`, `:` | ✅ | ✅ |
| 26 | `tim` | `at` | `at`, `am`, `tim` | `at` | `at`, `am`, `tim` | ❌ | ❌ |
| 27 | `na` | `na` | `na`, `di`, `ma` | `na` | `na`, `ma`, `di` | ✅ | ✅ |
| 28 | `-` | `-` | `-`, `##₂`, `:` | `-` | `-`, `##₂`, `##₃` | ✅ | ✅ |
| 29 | `da` | `pu` | `pu`, `tu`, `ti` | `pu` | `pu`, `ti`, `tu` | ❌ | ❌ |
| 30 | `šu` | `ma` | `ma`, `da`, `bi` | `da` | `da`, `zi`, `ma` | ❌ | ❌ |
| 31 | `a` | `a` | `a`, `da`, `na` | `a` | `a`, `na`, `pa` | ✅ | ✅ |
| 32 | `-` | `-` | `-`, `a`, `u` | `-` | `-`, `a`, `u` | ✅ | ✅ |
| 33 | `pa` | `be` | `be`, `e`, `i` | `be` | `be`, `e`, `a` | ❌ | ❌ |
| 34 | `##₃` | `##₃` | `##₃`, `##₇`, `##₂` | `##₃` | `##₃`, `##₇`, `##₂` | ✅ | ✅ |
| 35 | `ia` | `it` | `it`, `iš`, `šu` | `it` | `it`, `ma`, `šu` | ❌ | ❌ |
| 36 | `-` | `-` | `-`, `##₂`, `##₃` | `-` | `-`, `##₂`, `##₃` | ✅ | ✅ |
| 37 | `am` | `am` | `am`, `at`, `tim` | `am` | `am`, `at`, `tim` | ✅ | ✅ |
| 38 | `a` | `a` | `a`, `i`, `an` | `a` | `a`, `i`, `an` | ✅ | ✅ |
| 39 | `šu` | `ši` | `ši`, `ša`, `a` | `ši` | `ši`, `ša`, `a` | ❌ | ❌ |
| 40 | `##₂` | `##₂` | `##₂`, `##₃`, `##₄` | `##₂` | `##₂`, `##₄`, `##₃` | ✅ | ✅ |
| 41 | `-` | `-` | `-`, `:`, `.` | `-` | `-`, `:`, `.` | ✅ | ✅ |
| 42 | `ul` | `ul` | `ul`, `bu`, `lu` | `ul` | `ul`, `bu`, `ba` | ✅ | ✅ |
| 43 | `nu` | `ni` | `ni`, `na`, `nu` | `na` | `na`, `ni`, `nu` | ❌ | ❌ |
| 44 | `um` | `am` | `am`, `im`, `ma` | `um` | `um`, `ma`, `im` | ❌ | ✅ |
| 45 | `am` | `am` | `am`, `an`, `tim` | `tim` | `tim`, `am`, `an` | ✅ | ❌ |
| 46 | `im` | `im` | `im`, `iš`, `it` | `im` | `im`, `šu`, `ia` | ✅ | ✅ |
| 47 | `ma` | `ma` | `ma`, `na`, `D` | `ma` | `ma`, `D`, `na` | ✅ | ✅ |
| 48 | `sag` | `ur` | `ur`, `sag`, `ba` | `ur` | `ur`, `se`, `na` | ❌ | ❌ |
| 49 | `a` | `a` | `a`, `i`, `an` | `a` | `a`, `i`, `an` | ✅ | ✅ |
| 50 | `-` | `-` | `-`, `##₂`, `##r` | `-` | `-`, `##₂`, `##bru` | ✅ | ✅ |
| 51 | `##u` | `##u` | `##u`, `##a`, `##i` | `##u` | `##u`, `##a`, `##e` | ✅ | ✅ |
| 52 | `##₂` | `##₂` | `##₂`, `##₃`, `##₄` | `##₂` | `##₂`, `##₃`, `##₄` | ✅ | ✅ |
| 53 | `##b` | `##b` | `##b`, `##₂`, `##h` | `##b` | `##b`, `##₂`, `##h` | ✅ | ✅ |
| 54 | `šu` | `a` | `a`, `i`, `ki` | `a` | `a`, `i`, `ki` | ❌ | ❌ |
| 55 | `mi` | `na` | `na`, `ma`, `ti` | `na` | `na`, `ma`, `ti` | ❌ | ❌ |
| 56 | `en` | `en` | `en`, `nin`, `ul` | `en` | `en`, `nin`, `ul` | ✅ | ✅ |
| 57 | `-` | `-` | `-`, `la`, `ša` | `-` | `-`, `ša`, `šu` | ✅ | ✅ |
| 58 | `mu` | `-` | `-`, `kam`, `a` | `-` | `-`, `##m`, `kam` | ❌ | ❌ |
| 59 | `-` | `-` | `-`, `ma`, `##₃` | `-` | `-`, `ma`, `bi` | ✅ | ✅ |
| 60 | `ši` | `di` | `di`, `bi`, `ri` | `di` | `di`, `bi`, `ri` | ❌ | ❌ |
| 61 | `mu` | `i` | `i`, `mu`, `mi` | `mi` | `mi`, `i`, `mu` | ❌ | ❌ |
| 62 | `il` | `im` | `im`, `šu`, `ma` | `im` | `im`, `šu`, `ma` | ❌ | ❌ |
| 63 | `-` | `-` | `-`, `.`, `:` | `-` | `-`, `:`, `.` | ✅ | ✅ |
| 64 | `za` | `an` | `an`, `a`, `ba` | `an` | `an`, `pa`, `ba` | ❌ | ❌ |
| 65 | `'` | `'` | `'`, `##ʾ`, `##₂` | `'` | `'`, `##ʾ`, `##₂` | ✅ | ✅ |
| 66 | `du` | `dam` | `dam`, `a`, `ti` | `dam` | `dam`, `a`, `ti` | ❌ | ❌ |
| 67 | `-` | `-` | `-`, `ut`, `##₂` | `-` | `-`, `u`, `##₂` | ✅ | ✅ |
| 68 | `um` | `im` | `im`, `um`, `ti` | `im` | `im`, `um`, `-` | ❌ | ❌ |
| 69 | `kur` | `gal` | `gal`, `a`, `šu` | `gal` | `gal`, `a`, `mah` | ❌ | ❌ |
| 70 | `iu` | `nu` | `nu`, `mu`, `bu` | `mu` | `mu`, `bu`, `pu` | ❌ | ❌ |
| 71 | `u` | `u` | `u`, `i`, `ša` | `u` | `u`, `i`, `ša` | ✅ | ✅ |
| 72 | `lu` | `u` | `u`, `lu`, `du` | `u` | `u`, `lu`, `e` | ❌ | ❌ |
| 73 | `e` | `qa` | `qa`, `ša`, `sa` | `qa` | `qa`, `ša`, `sa` | ❌ | ❌ |
| 74 | `##zu` | `-` | `-`, `##₂`, `ša` | `-` | `-`, `##₂`, `##zu` | ❌ | ❌ |
| 75 | `##₂` | `##₂` | `##₂`, `##₆`, `##r` | `##₂` | `##₂`, `##e`, `##₆` | ✅ | ✅ |

Top-1 accuracy on this example: text-only 39/75 (52%), vision 39/75 (52%)

### Metadata predictions

| head | ground truth | text-only prediction | vision prediction |
|---|---|---|---|
| period | Old Babylonian | Old Babylonian (0.90) | Old Babylonian (0.95) |
| genre | Royal Inscriptions | Royal Inscriptions (0.68) | Royal Inscriptions (0.53) |
| language | Akkadian | Akkadian (0.75) | Akkadian (0.86) |
| provenience | Susa | Sippar (0.22) | Sippar (0.45) |
