...
8 hand-picked tablet(s) (`--tablet_ids`). Both models see the exact same masked positions per example (bold <strong>?</strong> shown at every chosen position, 15% of eligible tokens) -- differences in restoration come only from the two models' separately trained weights, not from the image itself (the image only reaches `provenience_head`, see module docstring). The metadata table's `provenience` row is where the image can actually change an answer.
...
> <strong>x</strong> <strong>x</strong> pi <strong>...</strong> e taš - hu <strong>x</strong> <strong>...</strong> im - mar <strong>x</strong> <strong>...</strong> ib - bu - u <strong>x</strong> <strong>...</strong> ib - ši šu <strong>...</strong> i - nak - kir <strong>x</strong> <strong>...</strong>
...
> <strong>x</strong> <strong>x</strong> <strong>?</strong> <strong>...</strong> e ta <strong>?</strong> - hu <strong>x</strong> <strong>...</strong> im - mar <strong>x</strong> <strong>...</strong> ib - bu - u <strong>x</strong> <strong>...</strong> ib - ši šu <strong>...</strong> i - <strong>?</strong> - ki <strong>?</strong> <strong>x</strong> <strong>...</strong>
...
> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> lu - u <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>?</strong> - ma kip - pa - ti₃ <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>?</strong> - <strong>?</strong> <strong>?</strong> ru lu da - an <strong>?</strong> - liš u šap - liš <strong>x</strong> <strong>x</strong> <strong>x</strong> - e pe - hi MA₂ u <strong>?</strong> - ṣur <strong>?</strong> - dan <strong>?</strong> na <strong>?</strong>₂ a <strong>?</strong> šap - pa - rak - ka MA₂ <strong>?</strong> - ru - um - ma KA <strong>?</strong> MA₂ tir - ra zi - <strong>?</strong> - <strong>?</strong> ina lib₃ - bi - ša₂ ŠE. BAR - ka NIG₂. <strong>?</strong> - ka u NIG₂. GA <strong>?</strong> <strong>?</strong> <strong>?</strong>₂ <strong>?</strong> šat - ka <strong>?</strong> - mat - ka sa <strong>?</strong> lat - ka u DUMU - MEŠ um - <strong>?</strong> - ni bu - <strong>?</strong> ED <strong>?</strong> u₂ - ma - am ED <strong>?</strong> ma - la U₂. ŠIM me - er - ʾi - sun a - šap - <strong>?</strong> - <strong>?</strong> - <strong>?</strong>m₂ - ma i - <strong>?</strong> - <strong>?</strong>ṣ - ṣa - ru KA₂ <strong>?</strong> <strong>?</strong> at - ra - ha - sis pa - a - šu₂ DU₃ - ma DUG <strong>?</strong>. <strong>?</strong> i - zak - kar ana e₂ - a be <strong>?</strong> li₂ - šu₂ <strong>?</strong> - ti - ma - a MA₂ ul e - pu - uš <strong>x</strong> <strong>x</strong> ina qaq - qa - ri e <strong>?</strong> ṣir u₂ - ṣur - tu₂ u₂ - ṣur <strong>?</strong> tu lu - mur <strong>?</strong> ma MA <strong>?</strong> lu - pu - <strong>?</strong> e₂ - a ina qaq <strong>?</strong> qa - ri e - <strong>?</strong> <strong>?</strong> u₂ - ṣur <strong>?</strong> <strong>?</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> be - li₂ ša₂ <strong>?</strong>q - ba - <strong>?</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong> <strong>x</strong>
...
> man - za - zu <strong>?</strong> - pa <strong>?</strong> aš <strong>?</strong> - <strong>?</strong> - ma is - sah - ra il - lik SI <strong>?</strong> u₂ - maš <strong>?</strong> šar : <strong>...</strong> u₂ - <strong>?</strong> - <strong>?</strong> - ma a - ri - ba u₂ - <strong>?</strong> - šar : <strong>...</strong> ik - kal i - <strong>?</strong>₂ - ah - hi i - tar - ri ul is <strong>?</strong> sah - ra
...
> mul - lil <strong>?</strong> <strong>?</strong> e u KI - <strong>?</strong>₃ <strong>...</strong> ša₂ a - na du - <strong>?</strong> - ni <strong>...</strong> a - bit <strong>?</strong> - MEŠ ša₂ <strong>...</strong>
...
**Masked input (4 positions):**
> <strong>...</strong> <strong>x</strong> TUKUL i - <strong>...</strong> <strong>...</strong> <strong>x</strong> ina GU. <strong>?</strong>A <strong>x</strong> <strong>...</strong> <strong>...</strong> + en - lil₂ KA - šu₂ <strong>?</strong> <strong>?</strong> <strong>?</strong> ma <strong>...</strong> <strong>...</strong> zag - ga - <strong>x</strong> <strong>x</strong> <strong>...</strong>
...
**Original text (transliteration):**
> i - zu - uz - zu <strong>...</strong> <strong>x</strong> mu <strong>...</strong> ṣe - eh - ri - im ša aš - ša - tum la ah - zu e - li - at ši₂ - ti - šu

**Cuneiform (Unicode signs, whole document, not position-aligned to the text above):**
> 𒍪 𒊻 x 𒈬 𒂊 𒄴 š 𒊭 𒌈 𒆷 𒀀 𒇷 𒀜

**Masked input (6 positions):**
> i - zu - <strong>?</strong> - zu <strong>...</strong> <strong>x</strong> mu <strong>...</strong> ṣe <strong>?</strong> eh - ri <strong>?</strong> im ša aš - ša - tum la ah - zu e - <strong>?</strong> - at ši₂ <strong>?</strong> ti <strong>?</strong> šu
...
**Masked input (11 positions):**
> ša ni - iš <strong>?</strong>₂ - <strong>?</strong> - šu IŠKUR i - du - u₂ mu - ne - eh li - <strong>?</strong> <strong>?</strong> bi IŠK <strong>?</strong> qu₂ - ra - <strong>?</strong> <strong>?</strong> im i - na IM mu <strong>?</strong> uš - <strong>?</strong> - ak - ki - in si - ma - tim i - na e₂ - u₄ <strong>?</strong> gal <strong>?</strong> gal
