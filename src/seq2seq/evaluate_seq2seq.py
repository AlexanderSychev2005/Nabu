"""CER/WER/exact-match evaluation for a trained signs->transliteration
seq2seq checkpoint.
...
from src.seq2seq.train_seq2seq import BASE_DIR, BOS, DEFAULT_REPO_ID, EOS, HF_CONFIG, PAD, encode, extract_pair
...
def main() -> None:
    ...
    ckpt = args.checkpoint or os.path.join(BASE_DIR, "checkpoints_seq2seq", HF_CONFIG, "best")
    ...
    pairs = [extract_pair(r) for r in ds[args.split]]
